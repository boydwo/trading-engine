...
#[test]
  fn limit_total_volume(){
    ...
    assert_eq!(limit.total_volume(), 200.00);
  }
    ...
    fn limit_order_multi_fill(){
        ...
        let mut market_sell_order: Order = Order::new(BidOrAsk::Ask, 199.0);
    ...
    fn limit_order_single_fill(){
        ...
        let mut market_sell_order: Order = Order::new(BidOrAsk::Ask, 99.0);
        limit.fill_order(&mut market_sell_order);
